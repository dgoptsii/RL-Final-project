...
LOG_STD_MIN = -20
LOG_STD_MAX = 2
DEFAULT_ALGORITHM_NAME = "sac_her"
...
def main():
    parser = argparse.ArgumentParser(description="Animate SAC + HER learning from saved episode checkpoints.")
    ...
    parser.add_argument("--out", type=str, default="results/animations/sac_her_learning.gif")
