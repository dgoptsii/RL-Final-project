...
def main():
    ...
    run_dirs = create_run_dirs("results", "td3", args.task, args.reward_type, args.seed)
    ...
    with open(csv_path, "w", newline="") as f:
        ...
        for episode in range(1, args.episodes + 1):
            ...
            while not (done or truncated):
                ...
                if replay.size >= args.batch_size:
                    for _ in range(args.updates_per_step):
                        ...
                        if not np.isnan(stats.actor_loss):
            ...
            print(
                f"Episode {episode:03d} | algo=td3 | task={args.task} | reward={args.reward_type} | "
