...
def main():
    ...
    algorithm = "sac_her" if args.use_her else "sac_no_her"
    ...
    with open(csv_path, "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow([
            "episode", "total_steps", "train_return", "train_true_success",
            "train_true_goal_distance", "eval_return", "eval_success", "eval_true_goal_distance",
        ...
        for episode_idx in range(1, args.episodes + 1):
            ...
            writer.writerow([
                episode_idx, total_steps, ep_return, ep_success, ep_distance,
            ...
            print(
                ...
                f"return={ep_return:.2f} | train_success={ep_success:.1f} (recent={recent_success_str}) | "
                f"dist={ep_distance:.4f} | eval_success={eval_success_str} | "
    ...
    summary = summarize_run(csv_path, "sac_her", args.task, args.reward_type, args.seed, args, model_path)
